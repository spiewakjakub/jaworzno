...
import { SliderDetailComponent } from 'app/entities/slider/slider-detail.component';
import { Slider } from 'app/shared/model/slider.model';

describe('Component Tests', () => {
  describe('Slider Management Detail Component', () => {
    let comp: SliderDetailComponent;
    let fixture: ComponentFixture<SliderDetailComponent>;
    let dataUtils: JhiDataUtils;
    const route = ({ data: of({ slider: new Slider(123) }) } as any) as ActivatedRoute;
