...
describe('Service Tests', () => {
  describe('Slider Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(SliderService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Slider(0, 'image/png', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Slider', () => {
        ...
        service.create(new Slider()).subscribe(resp => (expectedResult = resp.body));
