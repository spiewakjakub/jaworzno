...
describe('Service Tests', () => {
  describe('Poster Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(PosterService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Poster(0, 'image/png', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Poster', () => {
        ...
        service.create(new Poster()).subscribe(resp => (expectedResult = resp.body));
